...
import com.cornbreadandbeans.dojosforninjas.repositories.ChartUnitType;
import com.cornbreadandbeans.dojosforninjas.repositories.ZillowApiRepository;
...
import com.pholser.util.properties.PropertyBinder;
    ...
    public class ZillowApiService {
        ...
        private ZillowApiRepository properties;
        ...
        private void init() {
            PropertyBinder<ZillowApiRepository> binder = PropertyBinder.forType(ZillowApiRepository.class);
            try {
